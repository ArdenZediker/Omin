...
export const TOOL_MANIFESTS: ToolManifest[] = [
  ...
  { id: "search_sessions", command: "/search_sessions", title: "搜索会话", description: "按标题或内容检索本地会话" },
  { id: "read_session", command: "/read_session", title: "读取会话", description: "查看指定会话的上下文内容" },
  { id: "list_files", command: "/list_files", title: "列出文件", description: "浏览当前工作区文件与目录" },
  ...
  { id: "analyze_files", command: "/analyze_files", title: "分析文件", description: "组合搜索与阅读能力完成分析" },
];
